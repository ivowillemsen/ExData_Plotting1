...
png(filename = "plot1.png", width = 480, height = 480, units = "px", bg = "grey90")
plot.new()
par(mfrow = c(1, 1))
hist(powerdf$Global_active_power, xlab = "Global Active Power (kilowatts)", col="red", main='Global Active Power')
remove(powerdf)
dev.off()